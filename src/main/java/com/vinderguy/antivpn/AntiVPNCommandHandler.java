...
public final class AntiVPNCommandHandler implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args[0].equalsIgnoreCase("exempt")) {
            ...
            if (args[1].equalsIgnoreCase("remove")) {
                ...
                if (_plugin.removeExemptedIP(args[2])) sender.sendMessage(String.format(_plugin.getMessage("exempt-removed"), args[2]));
                else sendPredefinedMessage(sender, "exempt-does-not-exist");
    ...
    public @NotNull List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args[0].equalsIgnoreCase("exempt")) {
            ...
            if (args[1].equalsIgnoreCase("add")) return _plugin.getCachedBlockedIPs();
            if (args[1].equalsIgnoreCase("remove")) return _plugin.getExemptedIPs();
        }
